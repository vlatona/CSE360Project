	...
	private class ButtonHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent event) {
			...
			if (firstName.getText().isEmpty() || lastName.getText().isEmpty() || patientHeight.getText().isEmpty()
				...
				p = new Patient(firstName.getText(), lastName.getText());

				apt = new Appointment(patientHeight.getText(), patientWeight.getText(), patientBP.getText(), p);
				
				/*apt.addAllergy(allergies.getValue());
				apt.addConcern(concerns.getValue());
				...
				System.out.println("Patient Name: " + firstName.getText() + " " + lastName.getText());
				System.out.println();
				System.out.println("Allergies: " + allergies.getValue() + "\nConcerns: " + concerns.getValue() + "\nNew Medications: "
						+ medications.getValue());
			}
			...
			apt.setWeight(patientWeight.getText());
			apt.setBP(patientBP.getText());
			apt.setPatient(p);

			apt.addAllergy(allergies.getValue());
			apt.addConcern(concerns.getValue());
			apt.addMed(medications.getValue());
			apt.setSummary(apt.createSummary());*/
