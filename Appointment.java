...
public class Appointment 
{
	...
	//Send Prescriptions
	public boolean sendPrescriptions(PrescriptionHandler ph)
	{
		
		//Send prescriptions to pharmacy and return true/false
		boolean bool = ph.sendToPharmacy(patient.getPharmacy(), newMeds);
		return bool;
